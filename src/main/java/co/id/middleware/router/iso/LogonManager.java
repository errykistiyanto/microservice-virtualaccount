package co.id.middleware.router.iso;
...
public class LogonManager extends QBeanSupport {
    ...
    private static final String TRACE = "MIDDLEWARE_TRACE";
    private static final String LOGON = "MIDDLEWARE_LOGON.";
    private static final String ECHO = "MIDDLEWARE_ECHO.";
    ...
    private void doEcho() {
        ...
        try {
            ...
            if (resp != null) {
                ...
                Log.getLog(logger, logger).error("resp echo false");
